...
openclaw agent --session-id test_cuj_2 --message "请调用 exec 执行: SDLC_TEST_MODE=true python3 /root/.openclaw/skills/leio-sdlc/scripts/spawn_coder.py --pr-file /root/.openclaw/workspace/docs/PRs/dummy_pr.md --prd-file /root/.openclaw/workspace/docs/PRDs/dummy_prd.md"
