...
python3 scripts/spawn_reviewer.py --pr-file tests/dummy_triad_pr.md --diff-target HEAD --override-diff-file tests/dummy_triad.diff > tests/triad_reviewer.log 2>&1
