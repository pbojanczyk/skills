...
const TEXT_TO_IMAGE_DOC_URLS = [
  "https://docs.weryai.com/api-reference/character-image-generator/submit-text-to-image-task.md",
  "https://docs.weryai.com/api-reference/character-image-generator/submit-text-to-image-task",
];
const IMAGE_TO_IMAGE_DOC_URLS = [
  "https://docs.weryai.com/api-reference/character-image-generator/submit-image-to-image-task.md",
  "https://docs.weryai.com/api-reference/character-image-generator/submit-image-to-image-task",
];
