# `EXTEND.md` Schema (`character-image-generator`)

Configuration file paths, in priority order:

- `<project>/.image-skills/character-image-generator/EXTEND.md`
- `~/.image-skills/character-image-generator/EXTEND.md`

Optional model registry paths:

- `<project>/.image-skills/character-image-generator/MODELS.json`
- `~/.image-skills/character-image-generator/MODELS.json`
