...
- [text-to-image](https://docs.weryai.com/api-reference/character-image-generator/submit-text-to-image-task)
- [image-to-image](https://docs.weryai.com/api-reference/character-image-generator/submit-image-to-image-task)
