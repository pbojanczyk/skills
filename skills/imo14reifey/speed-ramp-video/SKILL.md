...
version: "1.0.3"
displayName: "Speed Ramp Video — Create Speed Ramp and Slow Motion Video Effects with AI"
description: >
  Speed Ramp Video — Create Speed Ramp and Slow Motion Video Effects with AI.
  ...
  and action replays. Combine speed changes with music sync — "slow down on the beat
  drop" — for music video style edits. Adjust playback speed from 0.1x ultra-slow to
  8x fast forward. No keyframing or timeline needed — describe the timing in words
