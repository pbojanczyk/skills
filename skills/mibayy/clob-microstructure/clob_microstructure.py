...
SKIP_PATTERNS = [
    # Pure random / low-edge sports micro
    "odd/even",
    "total rounds",
    "total kills",
    "handicap",
    ...
    "o/u 162",
    "o/u 1.5",
    # Weather markets — no microstructure edge
    "temperature",
    "celsius",
    "fahrenheit",
    "highest temp",
    ...
    "precipitation",
    "snow",
    # Political / macro — long-horizon, event-driven, no edge
    "governor",
    "election",
    "senate",
    "congress",
    ...
    "subscribers",
    "retweet",
    # Long-horizon resolution patterns
    "before 2027",
    "before 2028",
    "by 2027",
    "by 2028",
