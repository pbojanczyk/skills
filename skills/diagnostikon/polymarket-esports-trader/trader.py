...
Trades esports tournament, game release, and streaming milestone prediction markets on Polymarket using live match data and viewership signals.
...
KEYWORDS = ['esports', 'League of Legends', 'CS2', 'Counter-Strike', 'Dota 2', 'Valorant', 'Fortnite', 'World Championship', 'tournament', 'Steam', 'Twitch', 'game release', 'GTA 6', 'PlayStation', 'Xbox', 'Nintendo Switch', 'gaming revenue', 'Riot Games', 'Blizzard']
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(description="Trades esports tournament, game release, and streaming milestone prediction markets on Polymarket using live match data and viewership signals.")
